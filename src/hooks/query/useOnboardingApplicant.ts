...
export function useGetOnboardingApplicant(userId: number | undefined) {
  const setUser = useApplicantProfileStore((state) => state.setUser);
  const setApplicantProfile = useApplicantProfileStore((state) => state.setApplicantProfile);
  const setAcademicDetails = useApplicantProfileStore(
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      // Set type to Applicant to ensure correct MAX_STEP
      setType("applicant");
...
export function useUpdateStepOneOnboardingApplicant(userId: number | undefined) {
  return useMutation({
...
export function useUpdateStepTwoOnboardingApplicant(userId: number | undefined) {
  return useMutation({
...
export function useUpdateStepThreeOnboardingApplicant(userId: number | undefined) {
  return useMutation({
...
export function useUpdateStepFiveOnboardingApplicant(userId: number | undefined) {
  const nextStep = useOnboardingStore.getState().nextStep;
...
export function useUpdateStepSixOnboardingApplicant(userId: number | undefined) {
  return useMutation({
