      ...
      <header className="py-16 lg:py-20 bg-gradient-to-b from-muted/50 to-background border-b">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">Terms of Service</h1>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Please read these Terms of Service carefully before using SkillMatch. By accessing or using our
          ...
          <Card className="p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                SkillMatch (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) regarding your use of the SkillMatch
                platform (the &quot;Service&quot;).
              </p>
              <p>
                SkillMatch is an exclusive OJT placement platform designed for Quezon City University (QCU) students
                and verified partner companies. By creating an account or using our Service, you confirm that:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>You are at least 18 years of age</li>
                <li>You are a currently enrolled QCU student or authorized representative of a verified company</li>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-6 text-muted-foreground">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">2.1 Student Accounts</h3>
                <p>To create a student account, you must:</p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
                  <li>Be a currently enrolled student at Quezon City University</li>
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">2.2 Company Accounts</h3>
                <p>To create a company account, you must:</p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
                  <li>Be an authorized representative of a legitimate business</li>
                  <li>Be verified and approved by QCU or SkillMatch administration</li>
                  <li>Provide accurate company information and documentation</li>
                  <li>Agree to comply with additional company-specific terms</li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">2.3 Account Security</h3>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-6 text-muted-foreground">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">3.1 Permitted Use</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">3.2 Prohibited Conduct</h3>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-6 text-muted-foreground">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">4.1 Your Content</h3>
                <p>When you upload or post content (resumes, profiles, job postings, etc.), you:</p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">4.2 Our Content</h3>
                <p>
                  All SkillMatch platform features, design, text, graphics, logos, and source code are owned by
                  SkillMatch and protected by intellectual property laws. You may not copy, modify, or distribute our
                  content without permission.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">4.3 Content Moderation</h3>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-6 text-muted-foreground">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">5.1 Company Responsibilities</h3>
                <p>Companies must:</p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
                  <li>Post only legitimate, legal OJT opportunities</li>
                  <li>Provide accurate job descriptions and requirements</li>
                  <li>Comply with labor laws and anti-discrimination regulations</li>
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">5.2 Student Responsibilities</h3>
                <p>Students must:</p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
                  <li>Provide accurate and truthful information in applications</li>
                  <li>Only apply for positions they are qualified for and interested in</li>
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">5.3 No Employment Guarantee</h3>
                <p>
                  SkillMatch is a platform that facilitates connections between students and companies. We do not
                  guarantee employment, interview opportunities, or successful placements. All hiring decisions are
                  made solely by the companies.
                </p>
              </div>
            </div>
          </Card>
          ...
          {/* Google OAuth */}
          <Card className="p-8">
            <h2 className="text-2xl font-bold mb-4">6. Google OAuth and Third-Party Services</h2>
            <div className="space-y-4 text-muted-foreground">
              <p>
                SkillMatch uses Google OAuth for authentication. By using Google Sign-In, you agree to Google&apos;s Terms
                of Service and Privacy Policy in addition to ours.
              </p>
              <p>When you authenticate with Google:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>We only access your email, name, and profile picture</li>
                <li>We do not access your Gmail, Drive, or other Google services</li>
                <li>You can revoke our access at any time through your Google account settings</li>
                <li>We are not responsible for Google&apos;s services or policies</li>
              </ul>
            </div>
          </Card>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                <Link href="/privacy-policy" className="text-skillmatch-primary-green hover:underline font-medium">
                  Privacy Policy
                </Link>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Our collection and processing of your information as described in the Privacy Policy</li>
                <li>Sharing your application information with companies you apply to</li>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-6 text-muted-foreground">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">8.1 Service Provided &quot;As Is&quot;</h3>
                <p>
                  SkillMatch is provided on an &quot;as is&quot; and &quot;as available&quot; basis. We make no
                  warranties about the Service&apos;s reliability, accuracy, or availability. We do not guarantee:
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">8.2 Limitation of Liability</h3>
                <p>
                  To the maximum extent permitted by law, SkillMatch shall not be liable for any indirect, incidental,
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">8.3 User Verification</h3>
                <p>
                  While we verify QCU student status and company legitimacy, we cannot guarantee the accuracy of all
                  information provided by users. You are responsible for conducting your own due diligence when
          ...
          <Card className="p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">9.1 By You</h3>
                <p>
                  You may terminate your account at any time through your account settings or by contacting us. Upon
                  termination, you will lose access to your account and data.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">9.2 By Us</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-3">9.3 Effect of Termination</h3>
                <p>Upon termination:</p>
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
                  <li>Your access to the Service will cease immediately</li>
                  <li>Your profile and content may be removed</li>
                  <li>Certain provisions of these Terms will survive (e.g., disclaimers, limitations)</li>
                </ul>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <p className="mt-4">
                Your continued use of SkillMatch after changes become effective constitutes acceptance of the updated
          ...
          <Card className="p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                these Terms or your use of SkillMatch shall be resolved through:
              </p>
              <ol className="list-decimal list-inside space-y-2 ml-4">
                <li>Good faith negotiation between the parties</li>
                <li>Mediation, if negotiation fails</li>
                <li>Arbitration or courts in Quezon City, Metro Manila, Philippines</li>
              </ol>
            </div>
          </Card>
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <div className="space-y-2 mt-4">
                <div className="flex items-center gap-2">
                  ...
                  <a href="mailto:legal@skillmatch.com" className="text-skillmatch-primary-green hover:underline">
          ...
          <Card className="p-6 border-l-4 border-skillmatch-primary-green bg-muted/50">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                By using SkillMatch, you acknowledge that you have read, understood, and agree to be bound by these
          ...
          <div className="text-center pt-8 space-y-4">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Link href="/privacy-policy" className="text-sm text-skillmatch-primary-green hover:underline">
                Privacy Policy
              </Link>
