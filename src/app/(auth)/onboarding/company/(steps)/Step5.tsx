...
import { useUpdateStepFiveOnboardingCompany } from "@/hooks/query/useOnboardingCompany";
...
export default function Step5() {
  ...
  const { mutate, isPending } = useUpdateStepFiveOnboardingCompany(company_id);
  ...
  function handleNext() {
    ...
    const { error, data } = employerOnboardingStepFiveSchema.safeParse(paths);
